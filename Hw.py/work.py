...
engine = sqlalchemy.create_engine('postgresql://webadmin:HESadn49621@node36959-kamonwan.proen.app.ruk-com.cloud:11261/hw2')
...
user1 = Students(
    ...
    S_f_name='Kamonwan',
    S_l_name='Janmanee',
    S_e_mail ='6406022630016@kmutnb.ac.th'
)
...
user3 = Students(
    ...
    S_f_name='Piyawan',
    S_l_name='Nimpraprut',
    S_e_mail ='6406022610058@kmutnb.ac.th'
)
...
Subjects1 = Subjects(
    sub_id ='060233113',
    subject_name='Advance Computer Programming',
    credit='3',
    teacher_id ='AMK'
)
...
Subjects2 = Subjects(
    sub_id ='060233205',
    subject_name='Advance network and protocol',
    credit='3',
    teacher_id ='KNM'
)
